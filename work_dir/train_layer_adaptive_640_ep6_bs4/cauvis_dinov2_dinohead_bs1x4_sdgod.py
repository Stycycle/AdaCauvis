...
img_size = 640
launcher = 'none'
load_from = 'work_dir/train_layer_adaptive_640_ep6_bs4/epoch_5.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=6, type='EpochBasedTrainLoop', val_interval=6)
...
work_dir = 'work_dir/train_layer_adaptive_640_ep6_bs4'
